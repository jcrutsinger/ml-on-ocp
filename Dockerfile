...
RUN yum -y update; yum -y install wget; yum -y install cmake gcc gcc-c++ git make patch pciutils unzip vim-enhanced kernel-headers kernel-devel; yum clean all
